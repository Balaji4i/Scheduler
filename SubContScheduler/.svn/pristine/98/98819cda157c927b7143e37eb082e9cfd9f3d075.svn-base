...
public class ScheduleFrag {
    ...
    public void invoke(ActionEvent actionEvent) {
        ...
        /** FusionDomain **/
        String pod =
            getIt14().getValue() == null ? "null" : getIt14().getValue().toString();
        /** User Name**/
        String uname =
            getIt15().getValue() == null ? "null" : getIt15().getValue().toString();
        /** Password**/
        String pwd =
            getIt16().getValue() == null ? "null" : getIt16().getValue().toString();
        ...
        if (!freqMin.equals("null") && !freqMin.equals("0") &&
            ...
            while (rs.hasNext()) {
                ...
                try {
                    ...
                    r.setAttribute("ScheduleName",r.getAttribute("ScheduleName"));
                    r.setAttribute("BiReportPath",r.getAttribute("BiReportPath"));
                    r.setAttribute("BiReportName",r.getAttribute("BiReportName"));
                    r.setAttribute("DbRefreshPkg",r.getAttribute("DbRefreshPkg"));
                    r.setAttribute("FrequencyMin",new Long(r.getAttribute("FrequencyMin").toString()));
            ...
            // End of Iterator
            // Invoke
            RichCommandButton cb1 =(RichCommandButton)JSFUtils.findComponentInRoot("cb1");
    ...
    public void callCommitM() {
        ADFUtils.findOperation("callCommit").execute();
    }

    public void onClckOk(DialogEvent dialogEvent) {
        if (dialogEvent.getOutcome() == DialogEvent.Outcome.ok) {
//            ViewObject vo =
//                ADFUtils.findIterator("XxpmSetupDetailVO1Iterator").getViewObject();
//            RowSetIterator rsi = vo.createRowSet(null);
//            Row r = rsi.first();
            callCommitM();
        }
    }
